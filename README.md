...
- [ ] Mention two parts of Express that you learned about this week.
      You can write middleware with Express. Express allows the developer to access and send information through req, and res.

- [ ] Describe Middleware?
      Middleware are functions that can be used to send information through req and res.

- [ ] Describe a Resource?
      A resource is just an object that carries information to and from the database.

- [ ] What can the API return to help clients know if a request was successful?
      A status code..?

- [ ] How can we partition our application into sub-applications?
      We can separate things like routes and models into different folders and files.
